...
public class MaidPowerItems {
    public static final DeferredRegister<Item> ITEMS = DeferredRegister.create(ForgeRegistries.ITEMS, NativePowerOfMaid.MODID);
    ...
    public static final RegistryObject<Item> SOUL_OF_NATIVE_POWER = ITEMS.register("soul_of_native_power", NativePowerBaubleItem::new);
}
